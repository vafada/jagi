...
public abstract class AbstractChooseBox {
    ...
    protected SavedGame[] savedGames = new SavedGame[NUM_GAMES];

    protected abstract String getMessage();

    public AbstractChooseBox(String gameId, String path) {
        this.gameId = gameId;
        this.path = path;
        init();
    }
    ...
    protected void init() {
        ...
        StringTokenizer words = new StringTokenizer(getMessage(), " ", true);
    ...
    public SavedGame show(LogicContext logicContext, ViewScreen viewScreen) {
        KeyEvent ev;
